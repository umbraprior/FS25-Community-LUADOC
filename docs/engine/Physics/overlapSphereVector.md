...
> overlapSphereVector(vector center, float radius, string callbackFunctionName, object? callbackTargetObject, integer?
> collisionMask, boolean? includeDynamics, boolean? includeKinematics, boolean? includeStatics, boolean? exactTest)
