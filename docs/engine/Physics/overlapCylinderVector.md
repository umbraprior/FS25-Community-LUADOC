...
> overlapCylinderVector(vector center, float radius, float height, integer axis, string callbackFunctionName, object?
...
| string   | callbackFunctionName | overlapCylinderCallback(nodeId, subShapeIndex) -> boolean continueChecking                                                                                                       |
