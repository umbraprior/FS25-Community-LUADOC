...
> raycastAll(float x, float y, float z, float nx, float ny, float nz, float maxDistance, string callbackFunctionName,
> object? callbackTargetObject, integer? collisionMask)
